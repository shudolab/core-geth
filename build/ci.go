...
import (
	...
	"github.com/shudolab/core-geth/crypto/signify"
	"github.com/shudolab/core-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/shudolab/core-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/shudolab/core-geth/internal/version.gitDate="+env.Date)
	}
